...
export const metadata: Metadata = {
  ...
  description:
    "Madeena Catering & Event Management, Perintalmanna — wedding catering, buffets, live counters and complete event management across Malappuram. Rated 5.0 on Google. Open 24 hours. Call +91 94951 63651.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Wedding catering, buffets, live counters and complete event management across Malappuram. Rated 5.0 on Google.",
    images: [{ url: "/images/hero.webp", width: 1200, height: 630, alt: site.fullName }],
  },
